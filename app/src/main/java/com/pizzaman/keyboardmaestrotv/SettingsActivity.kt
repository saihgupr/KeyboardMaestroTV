...
class SettingsActivity : AppCompatActivity() {
    ...
    private fun setupFocusBehavior() {
        // Make back button behave like script cards
        ...
        // Make grid buttons behave like script cards
        gridColumnsDecrease.setOnFocusChangeListener { _, hasFocus ->
            if (hasFocus) {
                gridColumnsDecrease.animate()
                    .scaleX(1.05f)
                    .scaleY(1.05f)
                    .setDuration(200)
                    .start()
        ...
        gridColumnsIncrease.setOnFocusChangeListener { _, hasFocus ->
            if (hasFocus) {
                gridColumnsIncrease.animate()
                    .scaleX(1.05f)
                    .scaleY(1.05f)
                    .setDuration(200)
                    .start()
